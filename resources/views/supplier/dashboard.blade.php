...
<div class="container py-4">
    <h1 class="mb-4">{{ __('Supplier Dashboard') }}</h1>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card bg-primary text-white h-100">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    <a class="small text-white stretched-link" href="{{ route('supplier.products.index') }}">{{ __('View Details') }}</a>
        ...
        <div class="col-md-4 mb-4">
            <div class="card bg-success text-white h-100">
                ...
                <div class="card-footer d-flex align-items-center justify-content-between">
                    <a class="small text-white stretched-link" href="{{ route('supplier.orders.index') }}">{{ __('View Details') }}</a>
                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <a href="{{ route('supplier.products.create') }}" class="btn btn-primary w-100 mb-3">
                                <i class="fas fa-plus-circle me-2"></i>{{ __('Add New Product') }}
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="{{ route('supplier.orders.index') }}" class="btn btn-info w-100 mb-3">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <p><strong>{{ __('Company Name') }}:</strong> {{ auth()->user()->company_name }}</p>
                            <p><strong>{{ __('Business Type') }}:</strong> {{ auth()->user()->business_type }}</p>
